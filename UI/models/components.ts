     ...
     * @returns {TitleBuilder} A TitleBuilder instance, use .build() to create the element.
     */
     ...
     * @param {PseudoHtml<HTMLElement> | Component} father Specify the father object in wich you'll append the requested element.
     * @returns {AnchorBuilder} An AnchorBuilder instance, use .build() to create the element.
     */
     ...
     * @param {PseudoHtml<HTMLElement> | Component} father Specify the father object in wich you'll append the requested element.
     * @returns {ButtonBuilder} A ButtonBuilder instance, use .build() to create the element.
     */
     ...
     * @param {PseudoHtml<HTMLElement> | Component } father Specify the father object in wich you'll append the requested element.
     * @returns {FormBuilder} A FormBuilder instance, use .build() to create the element.
     */
     ...
     * @returns {InputBuilder} An InputBuilder instance, use .build() to create the element.
     */
    ...
    /**
     * Use this to create a select PseudoHtml instance. This method returns a Builder you can use to add new attributes to the html element. Finish the declaration with .build() to append the element to its father. You can also use .element after that to get the html element if needed.
     * @param {Form} father Specify the PseudoHtml instance in wich you'll append the requested element.
     * @returns {SelectBuilder} A SelectBuilder instance, use .build() to create the element.
     */
    addSelect(father: Form):SelectBuilder {
        const newSelectBuilder = new SelectBuilder(father)
